...
namespace MenaMap
{
    public partial class PolySiteMap : ContentPage
    {
        ...
        public PolySiteMap(string xstreet)
        {
            InitializeComponent();
           // LoadData(xstreet);
            ...
            MainMap.ShapeCoordinates.Add(new Position(37.797513, -122.402058));
            MainMap.ShapeCoordinates.Add(new Position(37.798433, -122.402256));
            MainMap.ShapeCoordinates.Add(new Position(37.798582, -122.401071));
            MainMap.ShapeCoordinates.Add(new Position(37.797658, -122.400888));

            MainMap.MoveToRegion(MapSpan.FromCenterAndRadius(new Position(37.79752, -122.40183), Distance.FromMiles(0.1)));
            }
